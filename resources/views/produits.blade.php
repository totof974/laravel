            ...
            <div class="col-md-9 det">
                <div class="single_left">
                    ...
                    <div class="desc1 span_3_of_2">
                        <h3>{{ $bladeprod->title }}</h3>
                        <span class="brand">Brand: <a href="#">{{ $bladeprod->brand }}</a></span>
                        <br>
                        <span class="code">Product Code: {{ $bladeprod->id }}</span>
                        <p>when an unknown printer took a galley of type and scrambled it to make</p>
                        <div class="price">
                            <span class="text">Price: {{ $bladeprod->price }}</span>
